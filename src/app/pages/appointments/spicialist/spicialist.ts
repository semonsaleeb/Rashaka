...
//   const dayNames = this.selectedSpecialist.working_days; // أيام العمل من API
//   const today = new Date();
...
//   // اسم اليوم من التاريخ اللي جاي من calendar
//   const dayName = day.toLocaleDateString('ar-EG', { weekday: 'long' });

//   // ✅ فقط الأيام الموجودة في working_days متاحة
//   return dayNames.includes(dayName);
// }
